...
bp1 <- barplot(pct_tab1,
        ...
        xaxt = "n",
        ylab = "Percentage",ylim=c(0,20))
mtext("Industry Type", side = 1, line = 4, cex = 1, font = 2,adj=0.2)
text(x = colMeans(bp1), y = -0.2, labels = colnames(pct_tab1),
     srt = 30, adj = 1, xpd = TRUE,cex=0.7)
grid(lty="dashed")
tab2<-table(data_latest$demographics.gender,data_latest$wealth.type)
...
ggplot(mean_industry, aes(x = wealth.how.industry, y = Mean_Wealth_in_Billions)) +
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 0.9, hjust = 1,
                                   size=14),plot.title = element_text(hjust = 0.5)
        ,axis.title.x = element_text(hjust=0.3,size=13))+
  geom_text(aes(label = Mean_Wealth_in_Billions), vjust = -0.3, size = 4)+
  labs(title = "Figure 3. Mean Wealth by Industry Type",
       x = "Industry Type",
       y = "Mean Wealth in Billions") 
...
ggplot(mean_wealthtype, aes(x = wealth.type, y = Mean_Wealth_in_Billions)) +
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 0.9, hjust = 1,
                                   size=15),plot.title = element_text(hjust = 0.5),
        axis.title = element_text(hjust = 0.3))+
  geom_text(aes(label = Mean_Wealth_in_Billions), vjust = -0.3, size = 4)+
  labs(title = "Figure 5. Mean Wealth by Wealth Type",
       x = "Wealth Type",
       y = "Mean Wealth in Billions") 
...
bp1 <- barplot(pct_tab1,
        ...
        xaxt = "n",
        ylab = "Percentage",ylim=c(0,20))
mtext("Industry Type", side = 1, line = 4, cex = 1, font = 2)
text(x = colMeans(bp1), y = -0.2, labels = colnames(pct_tab1),
     srt = 35, adj = 1, xpd = TRUE,cex=0.6)
grid(lty="dashed")
tab2<-table(data_latest$demographics.gender,data_latest$wealth.type)
pct_tab2 <- round(prop.table(tab2) * 100,1)
print(pct_tab2)
...
bp2 <- barplot(pct_tab2,
               ...
               xaxt = "n",
               ylab = "Percentage",ylim=c(0,30))
mtext("Wealth Type", side = 1, line = 4, cex = 1, font = 2,adj=0.3)
text(x = colMeans(bp2), y = -0.2, labels = colnames(pct_tab2),
     srt = 35, adj = 1, xpd = TRUE,cex=0.8)
grid(lty="dashed")
...
ggplot(data_latest, aes(x = wealth.how.industry,fill=demographics.gender)) +   
  ...
  labs( title="Group Bar Plot of Industry Type vs Gender",x = "Industry Type",y = "Frequency",
...
ggplot(data_latest, aes(x = wealth.type)) +   
  geom_bar(fill = "red") + theme(axis.text.x = element_text(angle = 45, vjust = 0.9, hjust = 1),plot.title = element_text(hjust = 0.5)) +
...
ggplot(data_latest, aes(x = demographics.gender,fill=wealth.type)) +   
  geom_bar(position= "dodge") + theme(axis.text.x = element_text(angle = 45, vjust = 0.9, hjust = 1),plot.title = element_text(hjust = 0.5)) +
  geom_text(
    stat = "count",
    aes(label = ..count..),
    position = position_dodge(width = 0.9),
...
bp1 <- barplot(pct_tab1,
        ...
        col = c("red", "blue","green"),
        legend.text = TRUE,
        main = "Billionaires by Industry Type and Gender (Percentages)",
        xaxt = "n",
        ylab = "Percentage",ylim=c(0,20))
text(x = colMeans(bp1), y = -0.2, labels = colnames(pct_tab1),
     srt = 35, adj = 1, xpd = TRUE,cex=0.6)
...
bp2 <- barplot(pct_tab2,
               ...
               col = c("red", "blue","green"),
               legend.text = TRUE,
               main = "Billionaires by Wealth Type and Gender (Percentages)",
               xaxt = "n",
               ylab = "Percentage",ylim=c(0,30))
text(x = colMeans(bp2), y = -0.2, labels = colnames(pct_tab2),
     srt = 35, adj = 1, xpd = TRUE,cex=0.8)
...
data_latest %>%
  ...
  pivot_wider(names_from = demographics.gender, values_from = percent, values_fill = 0)
